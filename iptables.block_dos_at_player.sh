...
#    iptables -v -I DOCKER -p tcp --dport $PORT ! -s $DOCKERNET -m recent -i eth0 --update --seconds 60 --hitcount 10 --rttl -j DROP
    iptables -v -I DOCKER -p tcp --dport $PORT -m recent -i eth0 --update --seconds 60 --hitcount 10 --rttl -j DROP
    iptables -v -I DOCKER -p udp --dport $PORT -m recent -i eth0 --update --seconds 60 --hitcount 10 --rttl -j DROP
done
exit
